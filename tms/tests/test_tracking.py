...
class TmsTrackingTests(unittest.TestCase):
    ...
    def test_tracking_ping_endpoint_stores_ping(self):
        ...
        self.assertTrue(payload["tracking_url"].endswith("/track/TMS-DEMO-003"))
    ...
    def test_public_tracking_page_only_shows_live_map_after_ping(self):
        before_response = self.client.get("/track/TMS-DEMO-003")
        ...
        after_response = self.client.get("/track/TMS-DEMO-003")
    ...
    def test_control_tower_data_includes_active_shipments_and_live_pings(self):
        ...
        self.assertEqual(payload["counts"]["at_risk"], 2)
        self.assertEqual(payload["counts"]["draft"], 1)
        self.assertEqual(payload["counts"]["delayed"], 0)
        ...
        self.assertEqual(shipment["health_key"], "at_risk")
